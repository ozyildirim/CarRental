...
namespace Business.Constants
{
    ...
    {
        internal static string MaintenanceTime = "The system is under construction.";
        ...
        public static string InvalidDailyPrice = "Invalid daily price.";
        internal static string CarListed = "Cars were listed.";
        internal static string CarDeleted = "The car has been deleted";
        internal static string CarUpdated = "The car has been updated";
